      ...
      <div className="relative z-10 container mx-auto max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 mt-8">
          ...
          <div className="flex items-center gap-6">
            {/* WhatsApp */}
            <a href="https://wa.me/34695283616" target="_blank" rel="noopener noreferrer" className="hover:opacity-60 transition-opacity">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/neonkyostudio" target="_blank" rel="noopener noreferrer" className="hover:opacity-60 transition-opacity">
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5">
