      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        <div className="flex justify-center mt-8">
          <div
            ...
            style={{
              clipPath: "polygon(28px 0, calc(100% - 28px) 0, 100% 14px, 100% calc(100% - 14px), calc(100% - 28px) 100%, 28px 100%, 0 calc(100% - 14px), 0 14px)"
            }}
          >
            <a
